      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-row gap-5 items-center mx-48">
          ...
          <div className="self-start flex flex-col gap-2 w-3/5">
            ...
            <div className="whitespace-nowrap text-4xl font-['Yeseva_One'] text-[#1f2b6c] mb-4 mr-32">
              FBlood supports voluntary blood donation
              <br />
            ...
            <div className="flex flex-row justify-between items-center mb-2 mr-[172px]">
              ...
              <div className="flex flex-row gap-2 items-center">
                <div className="bg-[#159eec] w-4 shrink-0 h-4 rounded-[50px]" />
                <div
                  className="whitespace-nowrap text-lg font-['Work_Sans'] leading-[25.2px] w-[114px]"
            ...
            <div className="font-['Work_Sans'] leading-[22.4px] mb-2">
              Welcome to Fblood - a modern and dedicated platform for the
              compassionate and hopeful community. We believe that each drop of
              blood holds immeasurable value and serves as a driving force to
              save lives.
            </div>
            <div className="font-['Work_Sans'] leading-[22.4px]">
              At Fblood, we focus on connecting the kind hearts of
              blood donors with those in need of help. Our mission is to ensure
              that blood donation becomes easy, safe, and convenient for
              everyone while promoting awareness about the significance of this
              act within the community.
            </div>
          </div>
        </div>
      </div>
      <div className="flex flex-col justify-between gap-16"style={{marginTop:-350}}>
        ...
        <div className="flex flex-row gap-5 items-start mx-48"style={{marginLeft:210}}>
          <div className="flex flex-col">
            <img
